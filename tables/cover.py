...
class Cover():
    ...
    def dur(self):
        ...
        for cas in self.fn.customers:
            cas_total = self.cas_duration[cas]
            t = [calculate_percente(self.fn.duration_customer_total_ly(cas),self.fn.duration_all_customers_total_ly())]
            ...
            for c in self.fn.channels:
                ...
                ch = [calculate_percente(self.fn.duration_channel_total_ly(cas,c),self.fn.duration_customer_total_ly(cas))]
                for q in range(1,self.QUARTER):
                    i = self.fn.range_by_quarter[q]
